...
export const AnimatedBorderButton = ({ children }) => {
  return (
    <button
      className="relative bg-primary/50 border border-border 
        text-foreground hover:border-gold transition-all 
        duration-1000 focus:outline-none focus-visible:ring-2 
        focus-visible:ring-primary focus-visible:ring-offset-2 
        disabled:opacity-50 disabled:cursor-not-allowed group 
        px-5 py-3 text-sm font-medium rounded-full overflow-visible 
        animated-border"
    >
      {/* Animated SVG Border */}
      <svg
